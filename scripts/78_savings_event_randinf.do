** RANDOMIZATION INFERENCE FOR EVENT STUDY OF SAVINGS VARIABLES
**  Sean Higgins
...
macro shift // so that `*' has any additional elements
	...
	//  nohup stata-mp -b do dofiles/savings_eventstudy_randinf.do 101 200 net_savings_ind_0_w5 &
...
local project 78_savings_event_`start_perm'_`end_perm'
cap log close
set linesize 200
...
if "`depvars'"=="" local depvars 
	net_savings_ind_0 
	net_savings_ind_0_w1 
	net_savings_ind_0_w5 
	net_savings_ind_0_asinh
;
#delimit cr
...
** DATA **
**********
use "$proc/netsavings_forreg_withperm`sample'.dta", clear
